...
namespace RPG_Data
{
    ...
    public abstract class Enemy
    {
        ...
        public int _unit_health { get; set; }            // запас здоровья юнита
        ...
        protected bool _InCombat = false;                // флаг состояния "в бою" для регенерации
        ...
        public abstract string GetUnitType();            // возвращает тип врага в виде строки
    ...
    public abstract class Player
    {
        ...
        public abstract void PrintUnitStatus();          // печать в консоль статуса по количеству хитпоинтов и положение на доске
        public abstract void PrintUnitType();            // печать в консоль типа юнита
        public abstract string GetUnitType();            // возвращает тип персонажа в виде строки
    ...
    public class Warrior : Player, ICombat
    {
        ...
        public string _unit_type = "Warrior";             // название типа юнита для печати
